...
public class MyMarketAppApplication {
    ...
    private Mono<Void> createOrders(
        ...
        Mono<Order> order1Mono = orderRepository.save(new Order(null, 4997L, LocalDateTime.now()));
        Mono<Order> order2Mono = orderRepository.save(new Order(null, 23997L, LocalDateTime.now().plusHours(1)));
